  ...
  return (
    <footer className="relative overflow-hidden flex w-full flex-col justify-center space-y-10 bg-opacity-50 backdrop-blur-md backdrop-filter">
      ...
      <nav className="flex justify-center flex-wrap gap-6 text-white font-sm mt-8 font-pixelate">
        <a
          className=" gap-5 w-fit bg-black/0 text-white text-md hover:text-md font-pixelate hover:font-bold hover:text-white rounded-none flex justify-center text-sm"
          href="#hero"
        >
          Home
        </a>
      ...
      <div className="flex justify-center items-center space-x-5">
        <a
          href="https://www.instagram.com/binary.kgec/"
          target="_blank"
        ...
        <a
          href="https://www.linkedin.com/company/binarykgec"
          target="_blank"
          rel="noopener noreferrer"
        >
    ...
    Sponsorship Brochure
      ...
      <p className="py-4 text-center font-medium text-white/60 flex items-center justify-center gap-0">
        <span className="text-4xl mr-0">&copy;</span> {new Date().getFullYear()}{" "}
